...
public class EmployeerController {
	...
	public ResponseEntity<List<JobSeeker>> getSeekersByJob(@RequestParam("jobId") int jobId,
			@RequestParam("employeerMail") String employeerMail) {

		try {
			List<JobSeeker> jobSeekers = employerService.getDetails(jobId, employeerMail);
			return ResponseEntity.ok().body(jobSeekers);
	...
	public ResponseEntity<Map<String, String>> getApplicationCount(
			@RequestParam("employeerMail") String employeerMail) {
		try {
	...
	@PostMapping("/Mail")
	public ResponseEntity<String> sendEmail(@RequestParam("employeerEmailId") String employeerEmailId,
			@RequestParam("jobseekerMailId") String jobseekerMailId, @RequestParam("username") String username,
			@RequestParam("status") String status, @RequestParam("jobId") int jobId) {
		try {
